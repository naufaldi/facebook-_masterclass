...
<resources xmlns:ns1="urn:oasis:names:tc:xliff:document:1.2" xmlns:ns2="http://schemas.android.com/tools">
    ...
    <string description="Shown when sending an email." name="com_accountkit_email_loading_title">Sending email…</string>
    ...
    <string description="Explanation that a person should look for a SMS confirmation code that was sent to the phone number %1$s" name="com_accountkit_enter_code_sent_to">Enter the code that was sent to %1$s</string>
